...
class DonorDetailV1 extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?DonorQuickStatsV1 $quickStats
     */
    #[JsonProperty('quick_stats')]
    public ?DonorQuickStatsV1 $quickStats;
     ...
     *
     * @var ?value-of<DonorDetailV1Role> $role
     */
    #[JsonProperty('role')]
    public ?string $role;
     ...
     * @param array{
     *   object?: ?string,
     *   quickStats?: ?DonorQuickStatsV1,
     *   id?: ?int,
     *   firstName?: ?string,
     *   lastName?: ?string,
     *   email?: ?string,
     *   phone?: ?string,
     *   role?: ?value-of<DonorDetailV1Role>,
     *   dateOfBirth?: ?int,
     *   birthMonth?: ?string,
     *   birthDay?: ?int,
     *   birthYear?: ?int,
    ...
    public function __construct(
        ...
        $this->quickStats = $values['quickStats'] ?? null;
