 ...
 */
class DonorActivityV1ListResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<DonorActivityV1> $data The page of items.
     */
    #[JsonProperty('data'), ArrayType([DonorActivityV1::class])]
    public ?array $data;
