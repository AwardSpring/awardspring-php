 ...
 */
class ScholarshipListItemV1ListResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<ScholarshipListItemV1> $data The page of items.
     */
    #[JsonProperty('data'), ArrayType([ScholarshipListItemV1::class])]
    public ?array $data;
     ...
     *   data?: ?array<ScholarshipListItemV1>,
     * } $values
     */
