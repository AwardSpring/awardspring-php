 ...
 */
class AwardCycleV1ListResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<AwardCycleV1> $data The page of items.
     */
    #[JsonProperty('data'), ArrayType([AwardCycleV1::class])]
    public ?array $data;
