 ...
 */
class FundListItemV1ListResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<FundListItemV1> $data The page of items.
     */
    #[JsonProperty('data'), ArrayType([FundListItemV1::class])]
    public ?array $data;
