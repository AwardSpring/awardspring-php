 ...
 */
class AwardedStudentV1ListResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<AwardedStudentV1> $data The page of items.
     */
    #[JsonProperty('data'), ArrayType([AwardedStudentV1::class])]
    public ?array $data;
